...
- **Why Fragmentation Happens:**  
  Different networks have different maximum transmission unit (MTU) sizes — the largest packet size allowed. If an IP datagram is larger than the MTU of the next network segment, it must be broken into smaller pieces, or fragments.
